...
export function Footer() {
  ...
  return (
    <footer className="bg-white" style={{ borderTop: '1px solid #e5e5e5' }}>
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-center text-sm text-slate-600" style={{ paddingLeft: '1rem', paddingRight: '1rem', paddingTop: '2rem', paddingBottom: '2rem' }}>
