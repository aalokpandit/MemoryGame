...
const navLinks = [
  ...
  { href: 'https://aalokdeep.com/coming-soon?feature=The+Workbench', label: 'Workbench', external: true },
  { href: 'https://aalokdeep.com/coming-soon?feature=The+Journal', label: 'Journal', external: true },
  { href: 'https://aalokdeep.com/coming-soon?feature=The+Gallery', label: 'Gallery', external: true },
...
export function Header() {
  ...
  return (
    <header className="bg-white" style={{ borderBottom: '1px solid #e5e5e5' }}>
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" style={{ paddingLeft: '1rem', paddingRight: '1rem' }}>
